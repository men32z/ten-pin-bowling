...
RSpec.describe 'More than 10 frames scenario' do
  describe 'more than 10 throws' do
    before(:each) do
      file = FileHelper.read('./spec/fixtures/more_than_10.txt')
    ...
    it 'should show just 10 throws with perfect score.' do
